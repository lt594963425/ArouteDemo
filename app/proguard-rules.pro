...
# and specify the fully qualified class person_name to the JavaScript interface
# class:
...
# hide the original source file person_name.
...
-keep public class com.paiwujie.robredpacket.base.AppLike {*;}
#
#---------------------------------实体类---------------------------------
