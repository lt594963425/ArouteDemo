package com.example.modulebase.aroute.inter;
...
public class RouteInterceptor implements IInterceptor {
    ...
    public void process(final Postcard postcard, final InterceptorCallback callback) {
        ...
        if (UserAroutePath.USER_ACTIVITY.equals(postcard.getPath())) {
            // 这里的弹窗仅做举例，代码写法不具有可参考价值

            final AlertDialog.Builder ab = new AlertDialog.Builder(AppManager.getAppManager().currentActivity());
    ...
    public void init(Context context) {
        mContext = context;
        Log.e("testService", RouteInterceptor.class.getName() + " has init.");
    }
}
