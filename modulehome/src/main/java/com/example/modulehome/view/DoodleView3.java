...
public class DoodleView3 extends ImageView implements LifecycleObserver {
    ...
    public DoodleView3(Context context) {
        super(context);
        init();
        autoBindLifecycle(context);
    }

    public DoodleView3(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
        autoBindLifecycle(context);
    }

    public DoodleView3 setCallBack(DoodleCallback callBack) {
